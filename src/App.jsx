      ...
      <div>
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              !loggedIn ? (
                <LoginComponent onSuccessfulLogin={handleSuccessfulLogin} />
              ) : (
                <Navigate replace to="/members" />
              )
            }
          />
          ...
          <Route
            path="/races"
            element={loggedIn ? <Races /> : <Navigate replace to="/login" />}
          />

          <Route
            path="/results"
            element={loggedIn ? <Results /> : <Navigate replace to="/login" />}
          />
